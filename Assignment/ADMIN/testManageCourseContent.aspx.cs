    ...
    public partial class WebForm11 : System.Web.UI.Page
    {
        ...
        protected void add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query1 = "insert into contentTable (contentID, courseID, title, content1, content2, content3, content4, image1, image2, image3, image4, video, chapter, sTitle1, sTitle2, sTitle3, sTitle4) " +
                        "values (@contentID, @courseID, @title, @content1, @content2, @content3, @content4, @image1, @image2, @image3, @image4, @video, @chapter, @sTitle1, @sTitle2, @sTitle3, @sTitle4) ";
                ...
                cmd1.Parameters.AddWithValue("@content1", cont1.Text);
                cmd1.Parameters.AddWithValue("@content2", cont2.Text);
                ...
                cmd1.Parameters.AddWithValue("@sTitle1", st1.Text);
                cmd1.Parameters.AddWithValue("@sTitle2", st2.Text);
                cmd1.Parameters.AddWithValue("@sTitle3", st3.Text);
                cmd1.Parameters.AddWithValue("@sTitle4", st4.Text);
        ...
        protected void edit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
            {
                ...
                string query = "UPDATE contentTable SET contentID = @contentID, chapter = @chapter, title = @title, content1 = @content1, content2 = @content2, content3 = @content3, content4 = @content4," +
                    "image1 = @image1, image2 = @image2, image3 = @image3, image4 = @image4, video = @video, sTitle1 = @sTitle1, sTitle2 = @sTitle2, sTitle3 = @sTitle3, sTitle4 = @sTitle4 WHERE contentID = @ContentID";
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@content1", cont1.Text);
                    cmd.Parameters.AddWithValue("@content2", cont2.Text);
                    ...
                    cmd.Parameters.AddWithValue("@sTitle1", st1.Text);
                    cmd.Parameters.AddWithValue("@sTitle2", st2.Text);
                    cmd.Parameters.AddWithValue("@sTitle3", st3.Text);
                    cmd.Parameters.AddWithValue("@sTitle4", st4.Text);
