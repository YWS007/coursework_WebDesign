    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select count (*) from memberTable where username = '" + username.Text + "'";
                ...
                else
                {
                    ...
                    string query1 = "insert into memberTable (fname, lname, gender, country, email, username, password) values (@firstName, @lastName, @gender, @country, @email, @username, @password) ";
                    ...
                    Response.Redirect("testMemberLogin.aspx");  //navigation for next page
