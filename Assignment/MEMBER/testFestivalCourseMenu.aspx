<%@ Page Title="" Language="C#" MasterPageFile="~/MEMBER/member.Master" AutoEventWireup="true" CodeBehind="testFestivalCourseMenu.aspx.cs" Inherits="Assignment.MEMBER.WebForm10" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Festival Course Menu</title>
<style type="text/css">
    .menu-item {
        width: 25%;
        float: left;
      ...
      <div class="container">
          <div class="row">
              ...
              <p>
               ...
               <h1 style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; font-weight: bolder; font-style: normal">FESTIVAL COURSE</h1>
