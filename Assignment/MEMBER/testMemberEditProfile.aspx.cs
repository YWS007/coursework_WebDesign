    ...
    public partial class WebForm9 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("select * from memberTable where username = '" + Session["userName"] + "'", con);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "update memberTable set fname ='" + fname.Text + "',lname ='" + lname.Text + "',gender ='" + gender + "',country ='" + country.Text + "',email ='" + email.Text + "',password ='" + pwd.Text + "',photo ='" + ImgPath + "'where username ='" + Session["userName"] + "'";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("testMemberEditProfile.aspx");
        }
